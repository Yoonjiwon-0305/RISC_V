...
HD_PWD='D:/Ondevice/RISC_V/RISC_V/0320_multi_RV32I/0320_multi_RV32I.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32I_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RV32I_top.tcl
