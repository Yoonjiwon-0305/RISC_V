...
HD_PWD='D:/Ondevice/RISC_V/RISC_V/0320_multi_RV32I/0320_multi_RV32I.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32I_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RV32I_top.tcl -notrace
